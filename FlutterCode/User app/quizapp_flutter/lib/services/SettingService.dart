...
class AppSettingService extends BaseService {
  ...
  Future<void> saveAppSettings(AppSettingModel appSettingModel) async {
    ...
    await setValue(TERMS_AND_CONDITION_PREF, appSettingModel.termCondition.validate().toString());
    await setValue(PRIVACY_POLICY_PREF, appSettingModel.privacyPolicy.validate().toString());
    await setValue(CONTACT_PREF, appSettingModel.contactInfo.validate().toString());
    await setValue(DISABLE_AD,appSettingModel.disableAd);
  }
}
