...
class QuizHistoryModel {
  ...
  QuizHistoryModel({this.id, this.quizAnswers, this.quizType, this.createdAt, this.totalQuestion, this.rightQuestion, this.quizTitle, this.image, this.userId, this.quizId});
