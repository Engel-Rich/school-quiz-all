...
////
  ...
  final _$classeModelAtom = Atom(name: '_AppStore.classeModel');

  @override
  String? get classeModel {
    _$classeModelAtom.reportRead();
    return super.classeModel;
  }

  @override
  set classeModel(String? value) {
    _$classeModelAtom.reportWrite(value, super.classeModel, () {
      super.classeModel = value;
    });
  }

  ///
  ///End Of class Model Atom
  ///
